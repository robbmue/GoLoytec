...
xmlns:
	...
	ReturnItemTime = "true"
	ClientRequestHandle = "Write-65"/ >
	< ItemList > < Items
	ItemPath = "User Registers.Seg04.Lights1.HmiLWeb"
	ItemName = "lampZoneState"
	ClientItemHandle = "gen0x01200091-2" > < Value
xsi:
	type = "xsd:int" > %v </Value > </Items > < Items
	ItemPath = "User Registers.Seg04.Lights1.HmiLWeb"
